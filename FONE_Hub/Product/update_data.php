    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="update_data_code.php" method="post">
                    <fieldset>
                        <legend>Update Phone Data</legend>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="unit_price" name="unit_price" required value="<?php echo $data['unit_price'] ?>">
                        </div>
